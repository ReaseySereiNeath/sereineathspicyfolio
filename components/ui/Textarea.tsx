...
const textareaVariants = tv({
	base: "w-full px-4 py-3 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:ring-offset-0 transition-colors duration-300 text-white placeholder-gray-600 resize-none",
	variants: {
		variant: {
			default:
